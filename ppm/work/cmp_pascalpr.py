"""Compare PASCALPR procedure bodies in a rebuilt codefile to ppm/PPM.CODE.

Body bytes are code_start:code_end (through the jump table's leading
words, not the whole codefile). Prints one line per procedure.
"""
import sys
...
a = seg(shipped, "PASCALPR")
b = seg(built, "PASCALPR")
