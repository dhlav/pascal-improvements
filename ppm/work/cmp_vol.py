"""Compare VOLUMEMA procedure bodies in a rebuilt codefile to ppm/PPM.CODE."""
import sys
...
built_path = Path(sys.argv[1]) if len(sys.argv) > 1 else root / "ppm" / "work" / "VOLLINK.CODE"
...
a = seg(shipped, "VOLUMEMA")
b = seg(built, "VOLUMEMA")
