"""Compare FILEHAND procedure bodies to ppm/FILER.CODE.

The extended filer is the segment named FILEHAND. Body bytes are
code_start:code_end. Prints one line per procedure.
"""
import sys
...
built_path = Path(sys.argv[1]) if len(sys.argv) > 1 else root / "ppm" / "work" / "FILEHAND.CODE"
